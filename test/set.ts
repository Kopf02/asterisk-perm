...
describe('Set permissions to obj', () => {
  describe('Set none existing values', () => {
    ...
    it('save new nested false value to obj', () => {
      const res = set('test2.test3', false, data);
  ...
  describe('Set already existing values', () => {
    ...
    it('update false value to obj', () => {
      ...
      assert.deepStrictEqual(
        data,
        { test: true, test2: false, test3: { test: true } },
        'Verify Permission Object Data'
      );
      assert.strictEqual(res, false, 'Marked as updated');
    });
    it('save new nested true value to obj', () => {
      const res = set('test3.test', true, data);
      assert.deepStrictEqual(
        data,
        { test: true, test2: false, test3: { test: true } },
        'Verify Permission Object Data'
    ...
    it('save new nested false value to obj', () => {
      const res = set('test3.test', false, data);
      assert.deepStrictEqual(
        data,
        { test: true, test2: false, test3: { test: false } },
        'Verify Permission Object Data'
      );
      assert.strictEqual(res, false, 'Marked as updated');
    });
  ...
  describe('Add nested Permissions to root Permission', () => {
    ...
    it('update true value to obj', () => {
      const res = set('test2.test', true, data);
      assert.deepStrictEqual(
        data,
        {
          test: true,
    ...
    it('update false value to obj', () => {
      const res = set('test2.test', false, data);
      assert.deepStrictEqual(
        data,
        {
          test: true,
    ...
    it('save new nested true value to obj', () => {
      const res = set('test3.test.hallo', true, data);
      assert.deepStrictEqual(
        data,
        {
          test: true,
    ...
    it('save new nested false value to obj', () => {
      const res = set('test3.test.hallo', false, data);
      assert.deepStrictEqual(
        data,
        {
          test: true,
  ...
  describe('Set root element in nested Permission', () => {
    ...
    it('Update nested true value to obj', () => {
      const res = set('test.test2', false, data);
      assert.deepStrictEqual(
        data,
        {
          test: {
    ...
    it('save new nested false value to obj', () => {
      const res = set('test.test3', true, data);
      assert.deepStrictEqual(
        data,
        {
          test: {
